<%-- 
    Document   : resp_estudiop3
    Created on : 21/07/2014, 10:44:30 AM
    Author     : COMER-01
--%>
...
<html>
    ...
    <body>
           <form action="guard_resp_estudiop3.jsp" method="POST">
        
            <center> <h1> "ENCUESTA SOBRE LAS HABILIDADES DE ESTUDIO" parte 3</h1></center>
           ...
           <table border="1" width=100% >
                ...
                <%
                    ...
                    ResultSet rs = st.executeQuery("SELECT * FROM cestudio where nivelp='3' order by idp ");
                    while (rs.next()) { %> 
                    <tr>
